 ...
 */
final class Version20240330133737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profile_setting (id INT AUTO_INCREMENT NOT NULL, form_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, slug VARCHAR(128) NOT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_4CCA6604989D9B62 (slug), INDEX IDX_4CCA66045FF69B7D (form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sample_image (id INT AUTO_INCREMENT NOT NULL, tags_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, is_published INT DEFAULT NULL, image VARCHAR(255) NOT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_CDEC0F50D17F50A6 (uuid), INDEX IDX_CDEC0F508D7B4FB4 (tags_id), INDEX IDX_CDEC0F50727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE system_form (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(128) NOT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, form_type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_43444EB9989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE profile_setting ADD CONSTRAINT FK_4CCA66045FF69B7D FOREIGN KEY (form_id) REFERENCES system_form (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile_setting DROP FOREIGN KEY FK_4CCA66045FF69B7D');
        ...
        $this->addSql('DROP TABLE profile_setting');
        ...
        $this->addSql('DROP TABLE system_form');
